...
function NotificationModal () {
    return(
        <div className={styles.notificationModalCon}>
            ...
            <img alt="notification image" className={styles.tooltipicon} src={`/assets/notificationImg.png`} />
            </div>
            <div className={styles.notificationModal}>
                ...
                <div className={styles.notificationmodalcontent}>
                    ...
                    <div className={styles.notificstionmodalcontentsec1}>
                        <img alt="notification image" src={`/assets/notificationImg.png`} />
                    </div>
                    ...
                    <div className={styles.acticeNotification}><img alt="active image" src={`/assets/active.svg`} /></div>
                </div>
                <div className={styles.notificationmodalcontent}>
                    <div className={styles.notificstionmodalcontentseccon}>
                    <div className={styles.notificstionmodalcontentsec1}>
                    ...
                    <div className={styles.acticeNotification}><img alt="active" src={`/assets/active.svg`} /></div>
                </div>
                <div className={styles.notificationmodalcontent}>
                    <div className={styles.notificstionmodalcontentseccon}>
                    <div className={styles.notificstionmodalcontentsec1}>
